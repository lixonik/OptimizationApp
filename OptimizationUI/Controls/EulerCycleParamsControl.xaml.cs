...
{
    public partial class EulerCycleParamsControl : UserControl, IGraphParams
    {
        public EulerCycleParamsControl() => InitializeComponent();
        ...
        public IGraphSolver CreateSolver(CancellationToken t)
        {
            ...
            p.Algorithm = "SA";
            return new EulerCycleSolver(p, t);
        }
    }
}
