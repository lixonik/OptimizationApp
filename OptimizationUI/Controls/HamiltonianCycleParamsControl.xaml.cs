...
{
    public partial class HamiltonianCycleParamsControl : UserControl, IGraphParams
    {
        public HamiltonianCycleParamsControl() => InitializeComponent();
        ...
        public IGraphSolver CreateSolver(CancellationToken token)
        {
            ...
            p.Algorithm = "SA";
            return new HamiltonianCycleSolver(p, token);
        }
    }
}
